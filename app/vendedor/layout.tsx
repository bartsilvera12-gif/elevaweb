    ...
    return (
      <div className="container-eleva pt-16 pb-24 max-w-md">
        <div className="card-flat p-8">
          ...
          <p className="text-sm text-[color:var(--color-ink-soft)] mt-2">Ingresá tu clave para gestionar tus productos, pedidos y cobros.</p>
    ...
    <div className="container-eleva pt-6">
      <div className="grid md:grid-cols-[220px_1fr] gap-6">
        <aside className="card-flat p-3 h-fit md:sticky md:top-24">
          <div className="text-xs font-bold uppercase tracking-wider text-[color:var(--color-muted)] px-2 py-2">Emprendedor</div>
